...
function App() {
  ...
  const validateInput = () => {
    ...
    // if (step == 2 || !formData.plan[0]) {
    //   err.plan = "select plan";
    // }
  ...
  return (
    <>
      <div className="w-[inherit] bg-slate-300  mx-auto h-[95vh] grid grid-cols-1  mt-0 md:w-2/3 md:min-h-[80vh] md:grid-cols-3 md:p-3 md:mx-auto md:my-8 md:bg-white rounded-lg border-2">
        {/* desktop sidebar */}
        <div className=" hidden md:block w-3/4   pt-10 rounded-md  col-start-1 col-end-2 bg-cover bg-center sidebar">
